...
function colormania() {
    ...
    function createBoard() {
        for (let i = 0; i < width * width; i++) {
            ...
            let randomColor = Math.floor(Math.random() * maniaColors.length);
            square.style.backgroundImage = maniaColors[randomColor];
    ...
    // Function is used to drop colors once some have been cleared
        ...
        for (i = 0; i < 55; i++) {
            if (squares[i + width].style.backgroundImage === "") {
                ...
                if (isFirstRow && squares[i].style.backgroundImage === "") {
                    ...
                    squares[i].style.backgroundImage = maniaColors[randomColor];
                }
            }
        }
    }
